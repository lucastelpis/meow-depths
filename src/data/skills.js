...
const tidal_wave = {
  ...
  icon: '🌊',
  description: 'Adds Splash Damage to Tidal Strike, hitting all other enemies besides the main target for a percentage of the full damage. The DEF reduction effect does not apply to these enemies.',
  stars: {
    1: { spreadPercent: 0.08 },
    2: { spreadPercent: 0.16 },
    3: { spreadPercent: 0.24 },
    4: { spreadPercent: 0.32 },
    5: { spreadPercent: 0.40 },
  },
};
